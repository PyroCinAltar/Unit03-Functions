...
def calculate_engagement(likes, shares, comments):
    """Calculate the total media engagement. This function takes the number of likes, shares, and comments on a post and returns the total engagement count.
...
def is_trending(likes):
    result = True if likes > 1000 else False
    return result
